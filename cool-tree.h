...
public:
   ...
   virtual Symbol class_name() = 0;
   virtual Symbol class_parent() = 0;
   virtual Features class_features() = 0;
   virtual Symbol class_filename() = 0;
...
public:
   ...
   virtual Symbol ename() = 0;
   virtual Formals eformals() = 0;
   virtual std::string etype() = 0;
   virtual Symbol ereturn_type() = 0;
   virtual Symbol etype_decl() = 0;
   virtual Expression eexp() = 0;
...
public:
   ...
   virtual std::string etype() = 0;
   virtual Expression eget() = 0;
   virtual Expression eget2() = 0;
   virtual Expression eget3() = 0;
   virtual Expressions ebody() = 0;
   virtual Symbol esymbol() = 0;
   virtual Symbol esymbol2() = 0;
...
public:
   ...
   Expression eexp(){return expr;}
   std::string etype(){return "method";}
   Symbol etype_decl(){}
...
public:
   ...
   Feature copy_Feature();
   void dump(ostream& stream, int n);
   Symbol ename(){return name;}
   Formals eformals(){}
   Symbol etype_decl(){return type_decl;}
   Expression einit(){return init;}
   std::string etype(){return "attr";}
   Symbol ereturn_type() {return type_decl;}
   Expression eexp(){return init;}
#ifdef Feature_SHARED_EXTRAS
   Feature_SHARED_EXTRAS
#endif
#ifdef attr_EXTRAS
...
public:
   ...
   void dump(ostream& stream, int n);
   std::string etype(){return "assign";}
   Expression eget(){return expr;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){return name;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "s_disp";}
   Expression eget(){return expr;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {return actual;}
   Symbol esymbol(){return name;}
   Symbol esymbol2(){return type_name;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "cond";}
   Expression eget(){return pred;}
   Expression eget2(){return then_exp;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "loop";}
   Expression eget(){return pred;}
   Expression eget2(){return body;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "typecase";}
   Expression eget(){return expr;}
   Expression eget2(){;}
   Expression eget3(){;}
   Expressions ebody(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "block";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3(){;}
   Expressions ebody(){return body;}
   Symbol esymbol(){;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "let";}
   Expression eget(){return init;}
   Expression eget2(){return body;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){return identifier;}
   Symbol esymbol2(){return type_decl;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "plus";}
   Expression eget(){return e1;}
   Expression eget2(){return e2;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "divide";}
   Expression eget(){return e1;}
   Expression eget2(){return e2;}
   Expression eget3() {;}
   Expressions ebody() {;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "int_const";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){return token;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "bool_const";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "string_const";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "new";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {;}
   Symbol esymbol(){return type_name;}
   Symbol esymbol2(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "is_void";}
   Expression eget(){e1;}
   Expression eget2(){;}
   Expression eget3() {;}
   Expressions ebody() {;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "no_expr";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3(){;}
   Expressions ebody(){;}
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
   std::string etype(){return "object";}
   Expression eget(){;}
   Expression eget2(){;}
   Expression eget3(){;}
   Expressions ebody(){;}
